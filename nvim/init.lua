...
vim.keymap.set('n', '<leader>rf', require('telescope.builtin').oldfiles, { desc = '[f] Find recently opened files' })
vim.keymap.set('n', '<leader>rp', require('telescope.builtin').oldfiles, { desc = '[p] Find recently opened projects' })
...
vim.keymap.set('n', '<leader>dd', require('telescope.builtin').diagnostics, { desc = 'Show Dashboard' })
...
-- Run make with F9
vim.api.nvim_set_keymap('n', '<C-m>', ':w | terminal make<CR>:startinsert<CR>', { noremap = true, silent = true })
